...
- A `Containerfile` that starts from stock Fedora Silverblue and adds: Tailscale, Nvidia drivers (open kernel modules, signed with a personal MOK key), nouveau blacklist, modprobe and dracut configs needed to make Nvidia + Wayland behave.
